...
@Document(collection = "customMaps")
public class MapData {
	...
	public String toString() {
		return "MapData [id=" + id + ", markers=" + markers + ", lines=" + lines + ", rects=" + rects + ", circles="
				+ circles + ", polys=" + polys + ", center=" + center + ", level=" + level + ", title=" + title
				+ ", content=" + content + "]";
	}
