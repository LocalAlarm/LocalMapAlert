...
public class FriendWebSocketHandler extends TextWebSocketHandler {
	...
	public void afterConnectionEstablished(WebSocketSession session) throws Exception {
		...
		if (token != null) {
			...
			UserRoomsDto userRoom = userRoomsService.getUserRoomsDtoById(token);
			String jsonUserRoom = objectMapper.writeValueAsString(userRoom);
			session.sendMessage(new TextMessage(jsonUserRoom));
		} else {
