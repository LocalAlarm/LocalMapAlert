...
//            });
       ...
       if (e.overlayType === daum.maps.drawing.OverlayType.POLYLINE) {
           ...
           var path = [];
    	   console.log("라인!!!!");
//     	   console.log(lineList.line);
//     	   console.log(line.points);
//     	   console.log(line.getPath());	
//     	   console.log(line);
    	   
    	   // lineList에서 해당 line 객체를 찾기
//     	    var foundLine = null;
//     	    for (var i = 0; i < lineList.length; i++) {
//     	    	console.log(lineList[i].id);
//     	        if (lineList[i].id === lineId) {
//     	            foundLine = lineList[i];
//     	            break;
//     	        }
//     	    }
//     	    console.log("라인!!!!");
...
//                line: line,
//             });
//            console.log("인포가져다 붙이기!");
//            console.log(lineList);
			    daum.maps.event.addListener(line, 'mouseover', function() {
					console.log("over line");
					console.log(line._index);
				});
				//클릭시 info닫기
				daum.maps.event.addListener(line, 'click', function() {
   ...
   function openMap() {
	...
	function drawMarker(markers) {
		...
		for (; i < len; i++) {
			...
			//            });
			var markerPosition = new kakao.maps.LatLng(markers[i].y,
					markers[i].x);
...
// 			console.log(lineList);
// 			for (var i = 0; i < lineList.length; i++) {
// // 				manager.remove(lineList[i].line);
// 				console.log(lineList[i].line);
// 			    lineList[i].line.setMap(null);
// 			}
// 			lineList = [];
// 		}
	}
